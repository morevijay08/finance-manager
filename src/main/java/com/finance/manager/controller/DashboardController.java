    ...
    protected void onTransactionEdit(Transaction transaction) {
        try {
            ...
            for (String pageName : pageNames) {
                ...
                if (pageObject instanceof Node page) { boolean active = page == editor; page.setVisible(active); page.setManaged(active); page.setMouseTransparent(!active); }
            }
            editor.toFront(); editor.requestFocus();
        } catch (Exception e) { statusLabel.setText("Could not open transaction editor."); }
    }
